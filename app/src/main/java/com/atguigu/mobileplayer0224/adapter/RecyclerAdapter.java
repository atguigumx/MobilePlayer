...
public class RecyclerAdapter extends RecyclerView.Adapter{
    ...
    public RecyclerAdapter(Context context, List<NetAudioBean.ListBean> datas){
        this.context=context;
        this.datas=datas;
    }
    @Override
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        return inintViewHolder(viewType);
    }
    ...
    private RecyclerView.ViewHolder inintViewHolder(int itemViewType){
